 ...
 */
export declare const resolveReferenceBrowser: <T extends unknown>(maybeReference: import("openapi-types").OpenAPIV3.ReferenceObject | T | undefined, document: OpenapiDocument | JSONSchema7, documentLocation: string) => Promise<T | undefined>;
